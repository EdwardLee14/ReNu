        ...
        <div>
            ...
            <div className='container mx-auto px-4 mb-16'>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
                    ...
                    <div className='bg-white border border-gray-200 rounded-xl overflow-hidden transition transform hover:shadow-xl hover:-translate-y-1'>
                        <div className='h-48 bg-gray-200 relative'>
                            <img src={returns} alt='returned electronics' className='object-cover h-full w-full' />
                        </div>
                        <div className='p-6'>
                    ...
                    <div className='bg-white border border-gray-200 rounded-xl overflow-hidden transition transform hover:shadow-xl hover:-translate-y-1'>
                        <div className='h-48 bg-gray-200 relative'>
                            <img src={produce} alt='produce' className='object-cover h-full w-full'/>
                        </div>
                        <div className='p-6'>
                ...
                <div className='text-center mt-12'>
                    <a href="/map" className='border border-green-600 text-green-600 hover:bg-green-50 px-8 py-3 rounded-full text-lg font-medium inline-block transition'>View All Products</a>
                </div>
            </div>
        </div>
    )
